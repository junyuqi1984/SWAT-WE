...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      pdvas(30) = usle
      pdvas(31) = sur_tmp(j)   !!37
      pdvas(32) = sol_tmp(1,j)
      pdvas(33) = sol_tmp(2,j)
      pdvas(34) = sol_tmp(3,j)
      pdvas(35) = sol_tmp(4,j)
      pdvas(36) = sol_tmp(5,j)
      pdvas(37) = sol_tmp(6,j)
      pdvas(38) = sol_tmp(7,j)
      pdvas(39) = sol_tmp(8,j)
      pdvas(40) = sol_tmp(9,j)
      pdvas(41) = sol_tmp(10,j)
      pdvas(42) = sol_nd(1,j)
      pdvas(43) = sol_nd(2,j)
      pdvas(44) = sol_nd(3,j)
      pdvas(45) = sol_nd(4,j)
      ...
      pdvas(49) = sol_nd(8,j)
      pdvas(50) = sol_nd(9,j)
      pdvas(51) = sol_nd(10,j)
      pdvas(52) = sol_st(1,j) + sol_wpmm(1,j)
      pdvas(53) = sol_st(2,j) + sol_wpmm(2,j)
      pdvas(54) = sol_st(3,j) + sol_wpmm(3,j)
      pdvas(55) = sol_st(4,j) + sol_wpmm(4,j)
      pdvas(56) = sol_st(5,j) + sol_wpmm(5,j)
      pdvas(57) = sol_st(6,j) + sol_wpmm(6,j)
      pdvas(58) = sol_st(7,j) + sol_wpmm(6,j)
      pdvas(59) = soltmp_50(j)    !!65
      pdvas(60) = soltmp_100(j)   !!66
      pdvas(61) = soltmp_150(j)   !!67
      pdvas(62) = soltmp_200(j)    !!68
      pdvas(63) = soltmp_300(j)    !!69
      pdvas(64) = soltmp_500(j)    !!70
      pdvas(65) = soltmp_1000(j)   !!71
      pdvas(66) =0
      yield = 0.
      pdvas(67) = 0
      pdvas(68) = 0
